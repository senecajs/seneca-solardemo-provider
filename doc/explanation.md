...
The SDK is an ordinary published dependency: `@voxgig-sdk/voxgig-solardemo` at
...
The source of truth is the SDK project's model — `../../voxgig-sdk/voxgig-solardemo-sdk` from
